                        ...
                        <ScrollReveal>
                            <div className={`${cardStyles} justify-between p-6 md:p-8`}>
                                ...
                                <div className="flex gap-2 mt-4 flex-wrap">
                                    ...
                                    <a href="/profile/CV_Sulthan_Abdi_Dzikry_Master.pdf" download="CV_Sulthan_Abdi_Dzikry_Master.pdf" target="_blank" rel="noreferrer" className="flex items-center gap-1.5 px-5 py-2 border border-border rounded-full text-[9px] font-bold hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all">
